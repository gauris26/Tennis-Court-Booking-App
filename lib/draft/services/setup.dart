...
Future<void> seed() async {
  var courts = await Hive.openBox<CourtModel>('Courts');
...
*/
  ...
  //var people = await Hive.openBox<PersonModel>('People');
  //var peopleWithSchedules = await Hive.openBox<ScheduleModel>('peopleWithSchedules');
...
*/
  ...
  var schedules = await Hive.openBox<ScheduleModel>('Schedules');
